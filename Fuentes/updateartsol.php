...
if ($accion=='guardar')
{
	...
	{
		echo "<font color='#FF0000'>No puede acreditar mayor cantidad que la habilitada por el stock o la solicitada en el pedido</font>";
	}
	else
	{
		...
		else
		{
			...
			{
				('Error No se pudo alterar la cantidad'.mysqli_error());
			}
			else
			{
...
<center>
<form name="datos" action="updateartsol.php?idart=<?php echo $idart;?>&idsol=<?php echo $idsol;?>&estadocall=<?php echo $estadocall;?>&unidadcall=<?php echo $unidadcall;?>" method="post">
<table class="inventario">
    <tr>
    <td align="center" colspan="2">
	<br>
	<font size="5" color="#000066"><img src="Images/editar.png" width="30" height="30" alt="Nuevo"/>  Alterando cantidad de Art&iacute;culo a entregar </font>
    </td>
    </tr>
    <tr>
	<td align="center" colspan="2">
  ...
  <tr>
    ...
    <table class="inventario">
      ...
      <tr>
        <td align="left"><label>Stock:</label></td>
        <td>
       	<input type="text" name="stkcant" maxlength="120" size="15" value="<?php echo $_SESSION['StkArtCantReal']; ?>" " readonly="readonly"/>
        </td>
      </tr>
      <tr>
        <td align="left"><label>Solicitados:</label></td>
        <td>
       	<input type="text" name="poracred" maxlength="120" size="15" value="<?php echo $laSolArt['StkSolArtCantSol']; ?>" " readonly="readonly"/>
        </td>
      </tr>
      <tr>
        <td align="left"><label>Falta entregar:</label></td>
        <td>
       	<input type="text" name="poracred" maxlength="120" size="15" value="<?php echo $_SESSION['StkSolArtCantAcred']; ?>" " readonly="readonly"/>
        </td>
      </tr>
      <tr>
        <td align="left"><label>Acreditar:</label></td>
        <td>
