...
<table align="center">
    ...
    <tr>
	<?php
	//Si el Autorizador cuenta al menos con 1 registro en StkArtClsUsu, es un autorizador con derechos a ver la nómina de articulos de las clases allí registradas
