<!--
Pendientes;
	1.- En $unidad esta hardcode "0"(todas), pero debería indicar la unidad real del usuario en caso que este tenga el perfil de solicitante, 
		solo debe ver la información de su unidad y no la de los demas.
	2.- Visibilidad de items del menu segun el perfil logged
-->
<?php
$estado="Pendiente de Entrega";
$unidad="0"; //para item "consulta" traiga el combo en todas
$clase="99";
$articulo="99";
$dia = date('d');
$mes = date('m');
...
<table align="center">
    ...
    <tr>
    <td align="center">
	<br><a href="index.php?estado=<?php echo $estado;?>&unidad=<?php echo $unidad;?>"><br><font style="font-family: 'Arial', Times, serif;font-size: 16px; font-weight: bold; color: #000066">Solicitudes</font></a>
    </td>
    </tr>
    <tr>
    <td align="center">
	<br><a href="articulos.php?clase=<?php echo $clase;?>&articulo=<?php echo $articulo;?>&fchdesde=<?php echo $fchdesde;?>&fchhasta=<?php echo $fchhasta;?>&actividad=<?php echo $actividad; ?>"><br><font style="font-family: 'Arial', Times, serif;font-size: 16px;font-weight: bold; color: #000066">Art&iacute;culos</font></a>
    </td>
    </tr>
    <tr>
    <td align="center">
	<br><a href="proveedoresfacstk.php"><br><font style="font-family: 'Arial', Times, serif;font-size: 16px;font-weight: bold; color: #000066">Proveedores</font></a>
    </td>
    </tr>	
    <tr>
    <td align="center">
    ...
    <tr>
    <td align="center">
        <br align="center"><a href="docs/Manual_Operador.doc" target="_blank" >Descargar ->> Manual</a>
    </td>
    </tr>
    <tr>
    <td align="center">
