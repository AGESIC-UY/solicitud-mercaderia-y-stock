...
<table align="center">
	...
	{
		$consulta="Select * from StkArtCls as c, StkArtClsUsu as u where c.StkArtClsBien='".$_COOKIE['tipobien']."' and c.StkArtClsId=u.StkArtClsId and u.UsuId='".$_COOKIE['usuid']."'";
    ...
    <tr>
    <td align="center">
	<br><a href="usuarios.php?unidad=<?php echo $uniusu;?>"><br><font style="font-family: 'Arial', Times, serif;font-size: 16px;font-weight: bold; color: #000066">Usuarios</font></a>
    </td>
    </tr>
    <tr>
    <td align="center">
    ...
    <tr>
    <td align="center">
        <br align="center"><a href="docs/Manual_Administrador.pdf" target="_blank" >Descargar ->> Manual</a>
    </td>
    </tr>
    <tr>
    <td align="center">
