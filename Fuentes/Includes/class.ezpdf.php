...
function ezProcessText($text){
  ...
  // purposes
  $search = array('<u>','<U>','</u>','</U>','Ã±','Ã³','íº','í©','Ã','í¡','í‰','í“','íš','í','invitacion','exposicion');
  $replace = array('<c:uline>','<c:uline>','</c:uline>','</c:uline>','ñ','ó','ú','é','í','á','É','Ó','Ú','Á','Invitación','Exposición');
