...
if ($accion=='guardar')
{
	...
	{
		//La sustitucion del articulo, libera la cantidad pedida ya que la sustitución podría cambiar en mayor o menor cantidad. 
		...
		//Haría un insert del nuevo articulo con su cantidad - objeto de agregar articulo a la solicitud
